...
export default function () {
  ...
  function startUp() {
    highPerformance = !isPlatformMobile() && !QueryString.lowPerformance,
      ...
      assetLibrary.queueAsset("skybox", "textures/skybox/specular/", AssetLibrary.Type.TEXTURE_CUBE),
      assetLibrary.queueAsset("irradiance", "textures/skybox/irradiance/", AssetLibrary.Type.TEXTURE_CUBE),
  ...
  function start(e, t) {
    var n = document.getElementById("playContainer");
    if (n.style.display = "none", mainProject = new SimpleThreeProject, mainProject.init(debugMode, assetLibrary), verifyExtension("EXT_blend_minmax") && verifyExtension("OES_texture_float_linear") && verifyExtension("EXT_frag_depth")) {
  ...
  THREE.EffectComposer = function (e, t) {
    ...
    Object.assign(THREE.EffectComposer.prototype, {
      ...
      render: function (e) {
        ...
        for (n = 0; n < r; n++) if (t = this.passes[n], t.enabled !== !1) {
  ...
  THREEx.RendererStats = function () {
    ...
    n.style.cssText = "color:#f00;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px",
      ...
      t.appendChild(n);
    for (var i = [], r = 9, o = 0; o < r; o++) i[o] = document.createElement("div"),
    ...
    return {
      domElement: e,
      update: function (e) {
        if (console.assert(e instanceof THREE.WebGLRenderer), !(Date.now() - a < 1e3 / 30)) {
          a = Date.now();
          var t = 0;
    ...
    THREE.RenderPass.prototype = Object.assign(Object.create(THREE.Pass.prototype), {
      ...
      render: function (e, t, n, i, r) {
        ...
        var a, s;
        this.clearColor && (a = e.getClearColor().getHex(), s = e.getClearAlpha(), e.setClearColor(this.clearColor, this.clearAlpha)),
    ...
    THREE.ShaderPass = function (e, t) {
      THREE.Pass.call(this),
        ...
        e instanceof THREE.ShaderMaterial ? (this.uniforms = e.uniforms, this.material = e) : e && (this.uniforms = THREE.UniformsUtils.clone(e.uniforms), this.material = new THREE.ShaderMaterial({
          defines: e.defines || {},
    ...
    AsyncTaskQueue.prototype = {
      ...
      _executeImpl: function () {
        if (this.onProgress.dispatch(this._currentIndex / this._queue.length), this._childQueues.length > 0) {
          var e = this._childQueues.shift();
          e.onComplete.bind(this._executeImpl, this),
            e.execute()
        } else if (this._queue.length === this._currentIndex) this.onComplete.dispatch();
        else {
    ...
    CalculateNormals = {
      doAll: function (e) {
        for (var t = 0; t < e.children.length; ++t) {
          var n = e.children[t];
          n.geometry && (n.geometry.computeVertexNormals(!1), n.geometry.normalsNeedUpdate = !0),
  ...
  var FloatTex = {
    ...
    QueryString = function () {
      for (var e = {},
        t = window.location.search.substring(1), n = t.split("&"), i = 0; i < n.length; i++) {
        var r = n[i].split("=");
  ...
  RectRenderer.prototype = {
    ...
    Signal.prototype = {
      ...
      dispatch: function (e) {
        for (var t = this._listeners.length,
          n = 0; n < t; ++n) this._listeners[n](e)
      },
      get hasListeners() {
    ...
    SwapMaterials = {
      ...
      swapSelectPartialMatch: function (e, t) {
        for (var n = 0; n < e.children.length; ++n) {
          var i = e.children[n];
          for (var r in t) t.hasOwnProperty(r) && i.name.indexOf(r) >= 0 && (i.material = t[r]);
          SwapMaterials.swapSelect(i, t)
        }
      }
    },
    ...
    EntityEngine.prototype = {
      ...
      update: function (e) {
        ...
        for (var t = this._updateableEntities,
          n = t.length,
          i = 0; i < n; ++i) t[i]._update(e)
      }
    },
    Component = function () {
      this._entity = null
    ...
    Entity = {
      ...
      convert: function (e) {
        Entity.isEntity(e) || (EntityPrototype._init(e), Entity.ENGINE.registerEntity(e))
      },
      destroy: function (e) {
      ...
      removeComponent: function (e, t) {
        if (!Entity.hasComponent(e, t)) throw new Error("Component wasn't added to this entity!");
        t.onRemoved();
        for (var n = !1,
          i = e._components.length,
          r = 0,
          o = [], a = 0; a < i; ++a) {
          var s = e._components[a];
          s !== t && (o[r++] = s, n = n || !!t.onUpdate)
        }
    ...
    SPHCollider.prototype = {
      ...
      update: function () {
        this._invalid && (this._updateMaterial(), this._rectRenderer.execute(this._material, this._target, !0), this._invalid = !1)
      },
  ...
  AssetLibrary = function (e) {
    ...
    AssetLibrary.prototype = {
      ...
      _json: function (e, t) {
        ...
        i.overrideMimeType("application/json"),
          ...
          i.onreadystatechange = function () {
            4 === i.readyState && "200" == i.status && (n._assets[t] = JSON.parse(i.responseText), n._onAssetLoaded())
          },
          i.send(null)
      },
      _plainText: function (e, t) {
        ...
        i.overrideMimeType("application/json"),
          i.open("GET", e, !0),
          i.onreadystatechange = function () {
            4 === i.readyState && "200" == i.status && (n._assets[t] = i.responseText, n._onAssetLoaded())
          },
          i.send(null)
      },
      _textureCube: function (e, t) {
        ...
        this._assets[t] = i.load([e + "posX.jpg", e + "negX.jpg", e + "posY.jpg", e + "negY.jpg", e + "negZ.jpg", e + "posZ.jpg"],
          function () {
            n._onAssetLoaded()
          }),
    ...
    BillboardComponent.prototype.onUpdate = function (e) {
      this._v.setFromMatrixPosition(this._camera.matrixWorld),
        ...
        this._constantSize && (this._v.copy(this.entity.position), this._v.applyMatrix4(this._camera.matrixWorldInverse), this.entity.scale.set(- this._v.z, -this._v.z, -this._v.z))
    },
    ...
    DielectricMaterial = function (e) {
      ...
      e.displacementMap && (t += "#define DISPLACEMENT_MAP\n"),
        ...
        void 0 !== e.color ? (e.color = new THREE.Color(e.color), e.color.convertGammaToLinear()) : e.color = new THREE.Color(16777215),
        e.emissionColor ? (e.emissionColor = new THREE.Color(e.emissionColor), e.emissionColor.convertGammaToLinear()) : e.emissionColor = new THREE.Color(0, 0, 0),
        e.specularProbeColor ? (e.specularProbeColor = new THREE.Color(e.specularProbeColor), e.specularProbeColor.convertGammaToLinear()) : e.specularProbeColor = new THREE.Color(1, 1, 1),
      ...
      THREE.ShaderMaterial.call(this, {
        ...
        e.normalMap && (this.extensions.derivatives = !0, this.uniforms.normalMap.value = e.normalMap),
        ...
        e.blending && (this.transparent = !0, this.blending = e.blending)
    },
    ...
    UnlitMaterial = function (e) {
      e = e || {};
      var t = "";
      e.color && (e.color = new THREE.Color(e.color), e.color.convertGammaToLinear()),
        (e.fogDensity || e.fogColor) && (t += "#define FOG\n"),
      ...
      THREE.ShaderMaterial.call(this, {
        ...
        e.blending && (this.blending = e.blending, this.transparent = !0, e.blending === THREE.AdditiveBlending && e.hdre && (this.blending = THREE.CustomBlending, this.blendSrc = THREE.OneFactor, this.blendDst = THREE.OneFactor, this.blendSrcAlpha = THREE.ZeroFactor, this.blendDstAlpha = THREE.ZeroFactor), e.blending === THREE.NormalBlending && e.hdre && (this.blending = THREE.CustomBlending, this.blendEquation = THREE.AddEquation, this.blendSrc = THREE.SrcAlphaFactor, this.blendDst = THREE.OneMinusSrcAlphaFactor, this.blendSrcAlpha = THREE.ZeroFactor, this.blendDstAlpha = THREE.OneMinusSrcAlphaFactor, this.blendEquationAlpha = THREE.AddEquation))
    },
    ...
    PoissonDisk.prototype = {
      ...
      generatePoints: function (e) {
        for (var t = 0; t < e; ++t) this.generatePoint()
      },
      generatePoint: function () {
        for (; ;) {
          for (var e = 0,
            t = this._currentDistance * this._currentDistance; e++ < this._maxTests;) {
            var n = this._getCandidate();
            if (this._isValid(n, t)) return void this._points.push(n)
          }
      ...
      _getCandidate: function () {
        for (; ;) {
          var e = 2 * Math.random() - 1,
            t = 2 * Math.random() - 1;
          if (this._mode == PoissonDisk.SQUARE || e * e + t * t <= 1) return new THREE.Vector2(e, t)
        }
      },
      _isValid: function (e, t) {
        for (var n = this._points.length,
          i = 0; i < n; ++i) {
          var r = this._points[i],
            o = e.x - r.x,
            a = e.y - r.y;
          if (o * o + a * a < t) return !1
        }
        return !0
      }
    },
      ...
      generatePoint: function () {
        for (; ;) {
          for (var e = 0,
            t = this._currentDistance * this._currentDistance; e++ < this._maxTests;) {
            var n = this._getCandidate();
            if (this._isValid(n, t)) return this._points.push(n),
              n
          }
          this._currentDistance *= this._decayFactor
        }
      ...
      _getCandidate: function () {
        for (; ;) {
          var e = 2 * Math.random() - 1,
            t = 2 * Math.random() - 1,
            n = 2 * Math.random() - 1;
          if (this._mode === PoissonSphere.BOX || e * e + t * t + n * n <= 1) return new THREE.Vector4(e, t, n, 0)
        }
      },
      _isValid: function (e, t) {
        for (var n = this._points.length,
    ...
    SPHContent.prototype = {
      init: function (e) {
        this._numLightSamples = 8,
          this._numVolumeSamples = 16,
          /* this._quality === SPH.Quality, */
          /* this._numVolumeSamples = this._quality === SPH.Quality.HIGH ? 16 : 8, */
          this._volume = 1,
          this._numParticles = 10240,
        ...
        if (!t.get("OES_texture_float_linear")) throw new Error("Float render targets are unsupported!");
        this._spawnRatio = .003,
          /* this._mode === SPHContent.BALL_MODE ? this._setup = new SPHBallSetup:  */
          this._mode === SPHContent.CASCADE_MODE && (this._setup = new SPHCascadeSetup(this._assetLibrary.get("cascademap")), this._spawnRatio = .001),
          ...
          this._mode === SPHContent.CASCADE_MODE && (this._fluidAbsorption = new THREE.Color(8, 25, 23), this._sph.viscosity = 50, this._sph.stiffness = 3, this._sph.surfaceTension = .25),
          ...
          this._initScene(),
          this._dragging = !1,
          /* this._mode === SPHContent.BALL_MODE ? this._initCollider() :  */
          this._initTerrain()
      },
      _onMouseDown: function (e) {
        this._updateRaycaster(e.clientX, e.clientY);
        var t = this._rayCaster.intersectObject(this._blocker);
        t.length > 0 && (this._dragging = !0, this._cameraController.enabled = !1)
      },
      ...
      update: function (e) {
        this._camera.updateMatrixWorld(!0),
          ...
          /* this._mode === SPHContent.BALL_MODE ? (this._setup.collider.spherePosition = this._blocker.position, this._sph.update(16)) :  */
          this._sph.update(8),
      ...
      _initCameraController: function () {
        ...
        e.azimuth = .5 * Math.PI,
          ...
          this._mode === SPHContent.CASCADE_MODE && (e.maxAzimuth = .5 * Math.PI - .5, e.minAzimuth = .5 * -Math.PI + .5)
      },
    ...
    SPHDistanceFieldRenderer.prototype = {
      ...
      render: function () {
        ...
        for (var e = -this._zRange; e <= this._zRange; ++e) this._material.zSliceOffset = e,
    ...
    SPH.prototype = {
      ...
      _initParticles: function () {
        for (var e = new THREE.Vector3,
          t = [], n = 0; n < this._maxParticles; ++n) this._setup.initParticlePosition(n, this._maxParticles, this._halfExtent, e),
            t.push(e.x, e.y, e.z, n + 1);
        var i = this._particleBufferSize.x * this._particleBufferSize.y;
        for (n = this._maxParticles; n < i; ++n) t.push(0, 0, 0, n + 1);
      ...
      _createPointGeometry: function () {
        for (var e = new THREE.BufferGeometry,
          t = [], n = [], i = [], r = this._particleBufferSize.x, o = this._particleBufferSize.y, a = 0; a < this._maxParticles; ++a) {
      ...
      update: function (e, t) {
        e *= .001,
          ...
          t = 2 | t,
          e /= t;
        for (var n = 0; n < t; ++n) this._updateBucket(),
          this._updateDensity(),
          this._updateAccel(e),
